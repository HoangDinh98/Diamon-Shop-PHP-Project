...
<div class="container">
  ...
  <button type="button" class="btn btn-default btn-lg" id="myBtn" data-toggle="modal" data-target="#login-form">Login</button>
  <button type="button" class="btn btn-default btn-lg" id="myregister" data-toggle="modal" data-target="#register-form">Register</button>
  <!-- Modal -->
