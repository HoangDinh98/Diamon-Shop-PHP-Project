...
<section class="main-content">
	...
	<h4><span>Chi Tiết Sản Phẩm</span></h4>			
		...
		<div class="span9">
			...
			<div class="span4">
			<!-- Sản phẩm chính -->			
                                                                    <a href="./asset/themes/images/ladies/daychuyen2.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="./asset/themes/images/ladies/daychuyen2.jpg"></a>												
                                                                    <ul class="thumbnails small">								
				<li class="span1">
				<!-- các sản phẩm liên quan bên dưới sản phẩm chính từng hình nhỏ -->
                                                                                      <a href="./asset/themes/images/ladies/daychuyen1.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="./asset/themes/images/ladies/daychuyen1.jpg" alt=""></a>
				</li>								
				<li class="span1">
                                                                                      <a href="./asset/themes/images/ladies/daychuyen3.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="./asset/themes/images/ladies/daychuyen3.jpg" alt=""></a>
				</li>													
				<li class="span1">
                                                                                      <a href="./asset/themes/images/ladies/daychuyen4.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 4"><img src="./asset/themes/images/ladies/daychuyen4.jpg" alt=""></a>
				</li>
				<li class="span1">	
                                                                                      <a href="./asset/themes/images/ladies/daychuyen5.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 5"><img src="./asset/themes/images/ladies/daychuyen5.jpg" alt=""></a>
				</li>
                                                                   </ul>
			</div>
			<div class="span5">
			...
			<div class="span9">
				...
				<li class=""><a href="#profile">Thông số</a></li>
                                                                    ...
                                                                    <div class="tab-content">
                                                                            <div class="tab-pane active" id="home">Dây chuyền món trang sức đang trở thành xu hướng thời trang được khá nhiều các bạn trẻ yêu thích. 
                                                                                Hơn hết các nàng có thể thỏa sức mix những kiểu mặt dây, mề đay lạ mắt, phá cách hoặc đánh dấu những khoảnh khắc đặc biệt, kể một câu chuyện của bản thân qua những hạt Charm nhỏ xinh. Còn chờ gì nữa các nàng ơi, hãy chọn cho mình một sợi dây chuyền và mặt dây phù hợp với tính cách và sở thích của bản thân đi nào!</div>
